...
const ApproveWarehousefinal = ({isOpenApproveWarehousefinal,onClickCloseApproveWarehousfinal,orderId,reCallAPI}) => {
  ...
  return (
    <AppDialog
    fullHeight={true}
    open={isOpenApproveWarehousefinal}
    onClose={onClickCloseApproveWarehousfinal}
    maxWidth='lg'
...
export default ApproveWarehousefinal;
ApproveWarehousefinal.propTypes = {
  onClickCloseApproveWarehous: PropTypes.func,
  onClickCloseApproveWarehousfinal: PropTypes.func,
  reCallAPI: PropTypes.func,
  isOpenApproveWarehousefinal: PropTypes.bool,
